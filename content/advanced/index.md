...
`观察共识`从本质上是多层级意识全体一致的可能性快照——达成共识的主体共享大体一致的实在，而存在`观察分歧`的快照则被忽略。这种被集体跟随的`一致快照`并非唯一。所谓的高维或低维，并非指物理空间，而是指采用不同观察模式从可能性基底中收敛出的不同`实在建构`。但观察共识在迭代交互中形成稳定且持续固化的可能性收敛路径，即为`因果`规律。所以，从人类视角看，因果规律似乎具有先验性，并能通过逻辑、数学、物理等不同形式表达。
