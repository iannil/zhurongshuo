...
确定性并非先在，而是从可能性基底中通过主体参与实现的「次级建构」。（2025-02-19）当我们称某现象为「确定」时，实则是某种意识结构在特定观察尺度上对「可能性分布」的「暂时锁定」。可以说，可能性是还未被观察锁定的确定性，且未必是物质倾向的。（2022-05-14）两者的唯一的差别在于是否被观察到。（2025-02-26）
...
当特定观察方式被多层级意识共享时，其协同产生的现象会强化该观察方式的稳定性。（2025-02-19）多层级意识在迭代交互中形成稳定的可能性收敛路径，其持续强化的收敛过程最终固化，被总结为「因果规律」。换句话说，任何现象都有意识参与。（2025-02-22）
