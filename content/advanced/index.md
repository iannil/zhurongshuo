...
确定性并非先在，而是从可能性基底中通过主体参与实现的「次级建构」。（2025-02-19）当我们称某现象为「确定」时，实则是可能性基底中以某种感知尺度对某种「可能性分布」的暂时锁定。这种特定尺度的感知即本文所定义的「观察」。

那么，可能性即是还未被观察锁定的确定性。其锁定的确定性可能是物质倾向的，也可能不是。（2022-05-14）两者的唯一的差别在于是否被观察到。（2025-02-26）

#### 1.2、确定性出现

「意识」作为可能性的「筛选机制」，通过「观察」对潜在可能性进行收敛。不同层级的意识持续观察，「被观察者」收敛为「客体」确定性，「观察者」收敛为「主体」确定性。一切存在皆可为观察者或被观察者，观察者既可以观察其作为「主体」的自身，也可以观察主体以外的「客体」。每个层级既保持自身特征，又与其他层级收敛结果持续的动态「交换」。（2025-02-19）。

观察者类型决定了被观察现象的表象特性。（2024-12-20）宏观层面物质的稳定性来自多层级观察的迭代收敛，最终固化为经典物理实体。而微观层面则表现为概率形态，微观不确定性则暴露不同观察主体间可能存在的观察分歧。（2025-02-12）观察未必严格按层级递进，如精密的测量仪器可直接观察微观粒子。（2025-01-03）

物质的「确定性」是多层级多类型的意识「集体的」持续观察的结果。各层级意识依据其识别精度构建相应物质结构认知，反之，物质的多层级也对应着意识的多层级。将某层级A的意识视为该层级的「主体」，那么该层级A的物质即为该层级的「客体」。另一层级B的意识同样可以被视为该层级B的「主体」，而层级A的物质与意识共同被层级B视为「客体」。「跨主体观察」的结果相互验证形成正向强化循环，某一层级的观察结果提供了另一层级的可观察范围，最终收敛确定为「客观存在」。（2025-01-08）

从基本粒子到生命体，一切存在形式均呈现不同层级的意识特征，这些「意识类型」分别以「独特方式」构建确定性图景，导致对实在不同层级的读取能力。（2025-02-11）人类意识是适应物质层级的「专门化」的模式识别类型，不同层级的意识有不同的「模式识别」。（2025-01-03）

#### 1.3、时空与因果

「时空连续性」是不同意识对动态存在以特定方式协同处理的结果。这种连续性并非物理实在的固有属性，而是意识模式识别的副产品，不同层级的意识以不同方式观察所体验的时空是不同的。（2022-04-24）

- 宏观层面：人类意识与人类身体协同，物质模式的序列感知被体验为在「既有空间」下匀速流动的「时间」。时空既非物理实在亦非纯粹幻觉，而是人类意识与身体处理序列信息的一般过程。（2023-09-21）
- 微观层面：微观粒子的某些行动则可能表现得并不受人类体验到的时空所约束。如将微观粒子加速到接近光速，又可以人为改变粒子原本的观察方式，从而表现出某些新的特性。（2025-01-03）
...
由此可知，确定性是普遍的观察共识，「自由意志」是可能性基底中尚未被锁定的「可用余量」。（2024-10-17）当「观察共识」达成，持续的共同观察结果收敛为持续的确定性「规则框架」，而当「观察分歧」出现，主体又会通过介入可能性实现二次收敛，完成规则框架的革新。主体在规则框架内即兴反应，该反应再反向重塑规则的可能性分布，形成反复连续的实在演化路径。这种演化放在物质时空之内即表现出渐进式「进化」的特点。（2025-02-16）
