...
- A
  ...
  - A/B 测试 (A/B Testing)
        ...
        - 书中应用：A/B 测试被视为一种将产品决策从"主观观点之争"转向"客观数据验证"的强大工具。它是一种"收敛"可能性的高效机制，能够帮助组织在无数个细微的决策点上，找到局部最优解。它代表了一种"认知谦逊"的文化，承认用户的真实行为是检验真理的唯一标准。
...
- B
  - 杠铃策略 (Barbell Strategy)
    ...
    - 关联概念：反脆弱性 (Antifragility)、非对称性 (Asymmetry)、黑天鹅 (Black Swan)、选择权 (Optionality)。
