---
title: "第八章、职业生涯中的选择权：打造T型人生的反脆弱性"
...
"T 型"只是一个起点。在一个更加复杂的世界里，你甚至可以追求成为一个"π 型"人才（拥有两个专业深度），或者一个"M 型"人才（拥有多个专业深度）。
...
进行自我评估：为每一项技能，进行一次诚实的打分（1-10 分）。
...
- 方法：
  ...
  - 建立你的"第二大脑"：使用印象笔记（Evernote）、Notion 等工具，建立一个你自己的、可搜索、可关联的个人知识库。将你所有的阅读笔记、思考和灵感，都记录其中。重要的不是"记住"，而是"记录"和"连接"。
