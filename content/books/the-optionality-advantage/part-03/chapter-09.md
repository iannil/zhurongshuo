...
Spotify的"部落、分队、小组和行会"（Tribes, Squads, Chapters, and Guilds）的组织模式，是敏捷思想在大型组织中的一次创造性应用。它将公司，分解成多个像"创业公司"一样运作的、跨职能的、高度自治的"分队"（Squads），每个分队都对产品的某个特定功能（比如，搜索或播放列表）负全责。
