...
### 从平台到协议（From Platforms to Protocols）
...
### 从数据垄断到数据主权（From Data Monopoly to Data Sovereignty）
...
### 从中心化认证到去中心化身份（From Centralized Authentication to Decentralized Identity, DID）
...
### 公共协商与公民议会（Public Deliberation and Citizens\' Assemblies）
...
### 数据合作社与数据信托（Data Cooperatives and Data Trusts）
