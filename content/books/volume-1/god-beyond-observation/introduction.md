...
千百年来，西方形而上学的主流传统，从柏拉图的"理型"到亚里士多德的"实体"，从基督教神学的"上帝本体"到笛卡尔的"思想实体"与"广延实体"，其核心关切始终围绕着一个"是"（is）字展开。它执着于探寻万物背后那个不变的、永恒的、作为终极实在的"本质"（essence）。世界被理解为由各种各样拥有固定属性的"事物"（things）所构成。在这种本体论的框架下，"神"自然被置于存在者之链的顶端，Ta 是"最真实的存在"（ens realissimum），是"自有永有者"（I am who I am），是一切存在的终极根据和源头。Ta 是一个"名词"，一个伟大的、拥有至高属性的"实体"。

这种"实体形而上学"或"存在本体论"（ontology of being）的思维模式，深刻地塑造了我们的语言习惯和认知结构。我们习惯于用名词来命名世界，用形容词来描述事物的属性。当我们思考一个问题时，我们总想找到一个确定的"答案"；当我们面对一个现象时，我们总想揭示其不变的"本质"。这种思维方式在处理宏观、稳定、界限分明的事物时，无疑是高效且成功的。它催生了古典科学的分类学、逻辑学和公理化体系。

然而，当我们用这套工具去处理那些最根本、最流动、最无法被对象化的问题时——-比如生命、意识、时间，以及最终的"神"——-它便开始捉襟见肘。我们将"神"对象化，试图用逻辑去证明 Ta 的存在或不存在，用属性去定义 Ta 的全知、全能、全善。我们就像一群试图用渔网去打捞流水的渔夫，网的结构越是精密，水的流失就越是彻底。神学变成了关于一个"超验客体"的复杂论证，信仰变成了对一系列关于这个客体的"命题"的接受。这种思维方式，正是导致前文所述的现代性困境的深层哲学根源。因为一旦你将神设定为一个"存在者"（a being），哪怕是最高的存在者，Ta 就必然会进入我们由科学、心理学和哲学所构建的认知框架中，被审视、被分析、被解构，并最终被发现其"不必要性"。

但是，如果真实（Reality）的根本性质不是静态的"是"，而是动态的"生"（becoming）呢？如果宇宙最底层的实在，不是一堆拥有固定属性的"积木"，而是一个持续不断的"生成过程"（process of generation）呢？

这便是本书所提议的根本性转向：从一种基于"存在"（Being）的本体论，转向一种基于"生成"（Becoming）或"涌现"（Emergence）的本体论我们不再追问"世界是什么"，而是追问"世界是如何从可能性中生成的？"；我们不再追问"神是什么"，而是追问"那个使得一切生成得以可能的过程或场域，其性质为何？"

为了阐述这一转向，本书将引入一个核心的概念框架，它由两个相互关联的要素构成："可能性基底"（Possibility Base）与"观察"（Observation）。

想象一个无限的、未分化的、蕴含着一切潜在可能的领域。它不是一片虚无，因为虚无意味着"什么都没有"，而它恰恰是"什么都有"的潜能。它也不是一个实体，因为它没有任何确定的形式、属性或边界。它先于时间、空间、物质和能量。所有我们能想到的、甚至无法想象的存在形式、物理法则、生命形态、意识状态，都以一种"潜能"或"倾向"（propensity）的方式，叠加共存于这个基底之中。它既非存在，亦非不存在，而是处于持续的、永恒的"将要存在"的生成过程之中。我们将其称为"可能性基底"。

这个概念并非凭空杜撰，它在人类思想史的深处有着诸多遥远的回响。在东方哲学中，老子的"道"——-"有物混成，先天地生。寂兮寥兮，独立而不改，周行而不殆，可以为天地母。吾不知其名，强字之曰道"——-正是对这个先于一切具象存在的、作为万物生成之源的描述。"道"是空虚的（"道冲，而用之或不盈"），却能生出万物（"道生一，一生二，二生三，三生万物"）。在佛教哲学中，龙树菩萨所阐发的"空性"（Śūnyatā）思想，同样指出一切现象（"法"）并无固定不变的"自性"，其本质是"缘起性空"。"空"并非断灭的虚无，而是指一切事物都处于相互依存、动态生成的网络之中，它正是一切现象得以显现的无限可能性空间。在西方神秘主义传统中，如爱克哈特大师所言的"神性"（Godhead）或"寂静的荒漠"，那个超越了人格神"上帝"（God）的、不可言说、不可思议的终极源头，也与"可能性基底"的概念有着惊人的相似性。

然而，如果存在着这样一个无限的可能性基底，为何我们所经验到的世界，却是一个由确定的、有形的事物所构成的、遵循着稳定规律的宇宙呢？

这就需要引入第二个核心概念："观察"。

在这里，"观察"一词的含义被极大地扩展了。它远不止是人类用眼睛去看，甚至不止是意识的认知活动。"观察"在这里被定义为任何一种导致"可能性"收敛为"确定性"的互动或筛选过程。它是一种从无限的潜在状态中，选择并"锁定"（lock-in）其中一种或一个子集，使其"坍缩"为现实的行动。

这个概念的灵感，部分来源于量子物理学中的"观察者效应"。在微观世界，一个粒子在被测量（观察）之前，可以同时处于多种可能状态的叠加态（例如，既在这里又在那里）；而一旦测量发生，它的状态就会瞬间"坍缩"，随机地呈现出其中一种确定的状态。我们将这个物理学中的惊人发现，提升为一个普适性的形而上学原理：一切"确定性"的存在，都是从"可能性基底"中通过某种形式的"观察"而收敛（converge）出来的结果。
