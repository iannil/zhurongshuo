...
description: "黄昏的巨响——现代性的精神困境与旧神学语言的失效 我们生活在一个悖论的时代。人类的足迹已踏上月球的尘埃，我们的探测器正孤独地穿越太阳系的边疆；我们以前所未有的精度绘制基因图谱，以前所未有的算力模拟宇宙的起源。我们手中的知识之火，其光芒之炽烈，足以照亮物质世界最深邃的角落。"
draft: false
hidden: false
tags: ["书稿"]
...
我们渴望觉知，却厌恶教条；我们向往超越，却无法回归前现代的信仰模式。我们站在语言的废墟之上，面对着一个沉默的宇宙，内心深处却依然回响着那个古老的问题：在这一切背后，是否还有什么更深邃的存在？在语言的尽头，我们究竟该如何谈论"神"？

这便是本书的出发点。它不试图去修复那座已经崩塌的旧神学大厦，不在废墟上用同样的砖石去重建一个稍作修改的模型。它提议，我们或许从一开始就问错了问题。我们之所以陷入困境，是因为我们始终在追问："存在是什么？"我们试图去定义神、定义灵魂、定义世界的本质，我们试图用名词和形容词去捕捉那个终极实在。而这场持续了数千年的追问，最终将我们引向了语言的牢笼和理性的绝境。

或许，是时候换一个问题了。或许，那个真正能开启新视域的问题是："存在是如何生成的？"

## 转向的枢纽——从"存在是什么"到"存在如何生成"

千百年来，西方形而上学的主流传统，从柏拉图的"理型"到亚里士多德的"实体"，从基督教神学的"上帝本体"到笛卡尔的"思想实体"与"广延实体"，其核心关切始终围绕着一个"是"字展开。它执着于探寻万物背后那个不变的、永恒的、作为终极实在的"本质"。世界被理解为由各种各样拥有固定属性的"事物"所构成。在这种本体论的框架下，"神"自然被置于存在者之链的顶端，Ta 是"最真实的存在"，是"自有永有者"，是一切存在的终极根据和源头。Ta 是一个"名词"，一个伟大的、拥有至高属性的"实体"。

这种"实体形而上学"或"存在本体论"的思维模式，深刻地塑造了我们的语言习惯和认知结构。我们习惯于用名词来命名世界，用形容词来描述事物的属性。当我们思考一个问题时，我们总想找到一个确定的"答案"；当我们面对一个现象时，我们总想揭示其不变的"本质"。这种思维方式在处理宏观、稳定、界限分明的事物时，无疑是高效且成功的。它催生了古典科学的分类学、逻辑学和公理化体系。

然而，当我们用这套工具去处理那些最根本、最流动、最无法被对象化的问题时——-比如生命、意识、时间，以及最终的"神"——-它便开始捉襟见肘。我们将"神"对象化，试图用逻辑去证明 Ta 的存在或不存在，用属性去定义 Ta 的全知、全能、全善。我们就像一群试图用渔网去打捞流水的渔夫，网的结构越是精密，水的流失就越是彻底。神学变成了关于一个"超验客体"的复杂论证，信仰变成了对一系列关于这个客体的"命题"的接受。这种思维方式，正是导致前文所述的现代性困境的深层哲学根源。因为一旦你将神设定为一个"存在者"，哪怕是最高的存在者，Ta 就必然会进入我们由科学、心理学和哲学所构建的认知框架中，被审视、被分析、被解构，并最终被发现其"不必要性"。

但是，如果真实的根本性质不是静态的"是"，而是动态的"生"呢？如果宇宙最底层的实在，不是一堆拥有固定属性的"积木"，而是一个持续不断的"生成过程"呢？

这便是本书所提议的根本性转向：从一种基于"存在"的本体论，转向一种基于"生成"或"涌现"的本体论我们不再追问"世界是什么"，而是追问"世界是如何从可能性中生成的？"；我们不再追问"神是什么"，而是追问"那个使得一切生成得以可能的过程或场域，其性质为何？"

为了阐述这一转向，本书将引入一个核心的概念框架，它由两个相互关联的要素构成："可能性基底"与"观察"。

想象一个无限的、未分化的、蕴含着一切潜在可能的领域。它不是一片虚无，因为虚无意味着"什么都没有"，而它恰恰是"什么都有"的潜能。它也不是一个实体，因为它没有任何确定的形式、属性或边界。它先于时间、空间、物质和能量。所有我们能想到的、甚至无法想象的存在形式、物理法则、生命形态、意识状态，都以一种"潜能"或"倾向"的方式，叠加共存于这个基底之中。它既非存在，亦非不存在，而是处于持续的、永恒的"将要存在"的生成过程之中。我们将其称为"可能性基底"。

这个概念并非凭空杜撰，它在人类思想史的深处有着诸多遥远的回响。在东方哲学中，老子的"道"——-"有物混成，先天地生。寂兮寥兮，独立而不改，周行而不殆，可以为天地母。吾不知其名，强字之曰道"——-正是对这个先于一切具象存在的、作为万物生成之源的描述。"道"是空虚的("道冲，而用之或不盈")，却能生出万物("道生一，一生二，二生三，三生万物")。在佛教哲学中，龙树菩萨所阐发的"空性"思想，同样指出一切现象("法")并无固定不变的"自性"，其本质是"缘起性空"。"空"并非断灭的虚无，而是指一切事物都处于相互依存、动态生成的网络之中，它正是一切现象得以显现的无限可能性空间。在西方神秘主义传统中，如爱克哈特大师所言的"神性"或"寂静的荒漠"，那个超越了人格神"上帝"的、不可言说、不可思议的终极源头，也与"可能性基底"的概念有着惊人的相似性。

然而，如果存在着这样一个无限的可能性基底，为何我们所经验到的世界，却是一个由确定的、有形的事物所构成的、遵循着稳定规律的宇宙呢？

这就需要引入第二个核心概念："观察"。

在这里，"观察"一词的含义被极大地扩展了。它远不止是人类用眼睛去看，甚至不止是意识的认知活动。"观察"在这里被定义为任何一种导致"可能性"收敛为"确定性"的互动或筛选过程。它是一种从无限的潜在状态中，选择并"锁定"其中一种或一个子集，使其"坍缩"为现实的行动。

这个概念的灵感，部分来源于量子物理学中的"观察者效应"。在微观世界，一个粒子在被测量(观察)之前，可以同时处于多种可能状态的叠加态(例如，既在这里又在那里)；而一旦测量发生，它的状态就会瞬间"坍缩"，随机地呈现出其中一种确定的状态。我们将这个物理学中的惊人发现，提升为一个普适性的形而上学原理：一切"确定性"的存在，都是从"可能性基底"中通过某种形式的"观察"而收敛出来的结果。

看似坚固的桌子，其稳定性来自于其亿万个原子、粒子之间持续不断的、极其复杂的相互"观察"(相互作用)，这种多层级的集体观察共识，使得桌子的宏观形态从无数种可能性中被牢牢锁定。一个思想的产生，是你的大脑神经网络中无数种潜在的电化学连接模式，在特定的内外刺激(观察)下，收敛为一条清晰的思维路径。生命的演化，是基因的随机变异(提供可能性)，在环境(观察者)的残酷筛选下，收敛出能够适应的物种形态。

在这个框架下，整个宇宙的历史，就是一部"观察"不断展开、可能性不断被收敛为现实的宏大史诗。从最初可能导致宇宙大爆炸的那个"原初观察"(或许是可能性基底的一次"自我观察")，收敛出我们这个宇宙特定的物理常数和法则；到星云在引力(一种宏观的观察机制)作用下收敛为恒星和行星；再到地球上，无机物在特定的化学环境(观察)中收敛出最初的生命形式；最终，演化出像人类这样拥有高度复杂意识的"高级观察者"。

我们，以及一切存在物，既是"被观察者"(我们是被更宏观的物理、化学、生物法则所收敛的产物)，同时也是"观察者"(我们的每一个行动、每一个选择、每一个念头，都在参与着对可能性的筛选与锁定，共同建构着我们自己和我们周遭的现实)。

这一从"存在是什么"到"存在如何生成"的转向，其意义是革命性的。它为我们走出前文所述的现代性困境，提供了一条全新的路径：

1. 它与科学非但不冲突，反而为科学提供了一个更深的哲学基础科学研究的，正是那些已经被稳定"收敛"出来的现实所遵循的"模式"或"规律"。科学探索的是"收敛之后"的世界，而我们所谈论的，是"收敛之前"的那个无限源头以及"收敛本身"这个行为。它将科学的实证领域与形而上学的思辨领域完美地衔接起来，而非相互对立。
2. 它重新为世界"赋魅"，但无需诉诸前现代的超自然神话在这个世界观里，现实并非一成不变的、由冷冰冰的物质构成的机器。现实是一个持续被创造、被生成、被参与建构的动态过程。每一个瞬间，都是一次从无限可能性之海中涌现出的奇迹。一块石头、一朵花、一个念头，都不仅仅是"它是什么"，更是"它如何战胜了无数种其他的可能性而成为它现在这个样子"的活生生的历史见证。
...
这个"神"，你无法用任何语言去定义 Ta，因为任何语言和概念本身就是一种"观察"，一种"收敛"。一旦你试图说出"神是……"，你就已经从无限的可能性中锁定了一个有限的、确定的属性，而这一定义行为本身，就背离了那个作为"所有可能性总和"的基底。因此，通往这个"神"的唯一语言路径，恰恰是古代神秘主义者所钟爱的"负神学"：我们只能说 Ta"不是"什么，通过不断地否定一切有限的定义，来无限地逼近那个不可言说的无限本身。
...
这个世界观最重要的实践意涵在于：我们并非被动地生活在一个预先设定好的、客观不变的现实中。我们是积极的参与者，我们的每一个意识活动，都在为这个世界的"实在性"投票。

它重新定义了"自由意志"。自由意志，不再是那个在"决定论"与"非决定论"之间争论不休的哲学难题。它被赋予了一个清晰的操作性定义：自由意志，就是我们每个人在已被高度锁定的现实共识中，所拥有的那部分尚未被完全收敛的"可用余量"我们的自由，体现在我们能否有意识地选择我们的"观察模式"，能否挑战既有的"收敛路径"，能否在看似别无选择的困境中，通过转换视角，为自己和世界"收敛"出新的可能性。
