...
第一，量化。评估的首要步骤，是将复杂的、多维度的、原本难以比较的社会现象与个人特质，转化为可计算、可比较的数字指标。无论是教育领域的绩点(GPA)、科研领域的 H 指数，还是社交媒体上的粉丝数、商业领域的客户终身价值(CLV)，其本质都是一种"量化简化"。这种简化过程并非价值中立，它必然会突出某些维度(通常是易于测量的维度)，而遮蔽其他维度(如创造力、同情心、伦理关怀等)。正如俗语所言，"什么被测量，什么就被完成"(What gets measured, gets done)。量化不仅是一种描述，更是一种规训，它通过设定测量指标，来引导和塑造被评估者的行为。
